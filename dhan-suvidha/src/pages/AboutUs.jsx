        ...
        <div className="row">
          ...
          <div className="col-sm-6" >
            ...
            <p className="boxAbt">	A different industry expert comes together for a common objective to serve the client on the single platform where they can have all the solutions related to finance.
                ...
                <br></br><br></br>
                We @DHANSUVIDHA created a portal where all the solutions related to finance can be solved under one roof as  DHAN stands for  “MONEY” and  SUVIDHA stands for “CONVENIENCE”.<br></br> <br></br>
