      ...
      >
        ...
        <div className="row">
          <div
            className="col-sm-3"
            style={{
              backgroundImage: `url(("../images/Loan.png"))`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "contain",
            }}
          ></div>
          ...
          <div className="serviceImageBox">
            <img className="serviceImage" src={preIpoImage} alt="IMAGE" />
            <img className="serviceImage" src={insuranceImage} alt="IMAGE" />
            <img className="serviceImage" src={itImage} alt="IMAGE" />
          </div>
        </div>
        <div className="row">
          <div
