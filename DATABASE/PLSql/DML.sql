/* Basic Commands
delete from  "REF"."REF_PROM_SOURCE" cascade;

ALTER SEQUENCE REF_PROM_SOURCE_id_SEQ RESTART WITH 1;

select * from REF_PROM_SOURCE rlt 

 */

-- MEM_TYPE
-- TRUNCATE TABLE REF_MEM_TYPE;
...
-- KYC_STATUS
-- TRUNCATE TABLE REF_KYC_STATUS;
INSERT INTO REF_KYC_STATUS (KYC_STATUS) VALUES ('COMPLETE');
INSERT INTO REF_KYC_STATUS (KYC_STATUS) VALUES ('PENDING');
INSERT INTO REF_KYC_STATUS (KYC_STATUS) VALUES ('REJECTED');

-- Loan Type
-- TRUNCATE TABLE REF_LOAN_TYPE;
...
-- Promotion source
insert into "REF"."REF_PROM_SOURCE" (prom_source) VALUES('Google search');
insert into "REF"."REF_PROM_SOURCE" (prom_source) VALUES('Dhansuvidha Employee');
insert into "REF"."REF_PROM_SOURCE" (prom_source) VALUES('promotion mails');


-- Country Dump
-- TRUNCATE TABLE REF_COUNTRY;
INSERT INTO REF_COUNTRY (ID, CONT_NAME_ISO2, CONT_NAME, CONT_NAME_NICE,CONT_NAME_ISO3, CONT_NUM_CODE, CONT_CODE) VALUES
